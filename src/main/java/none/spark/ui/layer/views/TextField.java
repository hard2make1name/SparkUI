...
public class TextField extends View {
    ...
    // After instance, if both renders and events are managed by themselves, then performance is lower, so render to the ViewRenderer and event to the UIEventManager

    // runtime
    public int mouseBeginPosX = 0, mouseBeginPosY = 0, mouseEndPosX = 0, mouseEndPosY = 0;
